...
export const AddUser: React.FC = () => {
  ...
  const [form, setForm] = useState<Partial<User>>({
    name: '', username: '', password: '', email: '', phone: '', address: '', role: 'staff', modules: ['candidates']
  });
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h1 className="text-2xl sm:text-3xl font-bold mb-6">{id ? 'Edit User' : 'Add New User'}</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="border-t border-gray-100 pt-4 mb-4">
            ...
            <div className="mt-3">
              ...
              <textarea
                className="w-full bg-white border border-gray-300 rounded-lg px-4 py-2 text-gray-900 focus:ring-1 focus:ring-spr-accent outline-none text-sm"
                value={form.address || ''}
