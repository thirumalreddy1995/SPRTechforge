              ...
              <div className="space-y-6">
                {[
                  ...
                  },
                  {
                    ...
                    title: 'Email', body: 'admin@sprtechforge.com', href: 'mailto:admin@sprtechforge.com'
                  },
                  {
                    icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />,
                    title: 'Careers & Training', body: 'hr@sprtechforge.com', href: 'mailto:hr@sprtechforge.com'
                  },
                  {
                    icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />,
                    title: 'Mobile / WhatsApp', body: '+91 82972 76500', href: 'tel:+918297276500'
                  },
                  {
            ...
            <div>
              ...
              <ul className="space-y-4 text-gray-500 text-sm font-semibold">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <a href="mailto:admin@sprtechforge.com" className="hover:text-white transition-colors break-all">admin@sprtechforge.com</a>
                </li>
                <li className="flex items-center gap-3">
                  <svg className="w-4 h-4 text-blue-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                  <a href="mailto:hr@sprtechforge.com" className="hover:text-white transition-colors break-all">hr@sprtechforge.com</a>
                </li>
                <li className="flex items-center gap-3">
                  <svg className="w-4 h-4 text-blue-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                  <a href="tel:+918297276500" className="hover:text-white transition-colors">+91 82972 76500</a>
                </li>
              </ul>
            </div>
          </div>
