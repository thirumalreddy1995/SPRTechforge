...
export const LandingPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    addWebLead({ name: form.name.trim(), phone: form.phone, email: form.email.trim() || undefined, service: [form.interest, form.mode].filter(Boolean).join(' · ') || undefined, message: form.message.trim() || undefined });
    setFormSuccess(true);
