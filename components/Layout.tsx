        ...
        <nav className="p-3 overflow-y-auto h-[calc(100vh-80px)] scrollbar-hide">
          {user.role !== 'candidate' ? (
            <>
              ...
              >
                <NavItem to="/community" label="Home" onClick={closeMobile} isSidebarCollapsed={isSidebarCollapsed} setIsSidebarCollapsed={setIsSidebarCollapsed} />
                {isMaster && <NavItem to="/dashboard" label="Dashboard" onClick={closeMobile} isSidebarCollapsed={isSidebarCollapsed} setIsSidebarCollapsed={setIsSidebarCollapsed} />}
              ...
              >
                <NavItem to="/community" label="Community" onClick={closeMobile} isSidebarCollapsed={isSidebarCollapsed} setIsSidebarCollapsed={setIsSidebarCollapsed} />
